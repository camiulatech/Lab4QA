...
public class MercuryTours_AutomatedTest {
	...
	public void registerUser() throws InterruptedException {
		...
		if(driver.findElement(registerPageLocator).isDisplayed()) {
			driver.findElement(usernameLocator).sendKeys("camiu");
			driver.findElement(passwordLocator).sendKeys("coquito2110");
			driver.findElement(confirmPasswordLocator).sendKeys("coquito2110");
		...
		assertEquals("Note: Your user name is camiu.", fonts.get(5).getText());
	}
	
	@Test
	public void signIn() throws InterruptedException {
		if(driver.findElement(userLocator).isDisplayed()) {
			driver.findElement(userLocator).sendKeys("camiu");
			driver.findElement(passLocator).sendKeys("coquito2110");
